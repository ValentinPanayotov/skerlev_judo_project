...
##loading data
library(gdata)
w_ch=read.xls("svilen.data_chin.xls", header=T)
w_sq=read.xls("svilen.data_squat.xls", header=T)
w_b=read.xls("svilen.data_bench.xls", header=T)
##converting data to .csv
write.csv(w_sq, file="svilen.data_squat.csv")
write.csv(w_b, file="svilen.data_bench.csv")
write.csv(w, file="svilen.data_score.csv")
w_sq=read.csv("svilen.data_squat.csv")
w_b=read.csv("svilen.data_bench.csv")
w_ch=read.csv("svilen.data_chin.csv")
w=read.csv("svilen.data_score.csv")
